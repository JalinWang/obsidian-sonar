...
export interface SonarSettings {
  ...
  rerankMultimodal: boolean; // Whether the rerank model supports multimodal input (images)
  ...
  includeTitleInQuery: boolean; // Prepend the active note's title to the related notes search query
